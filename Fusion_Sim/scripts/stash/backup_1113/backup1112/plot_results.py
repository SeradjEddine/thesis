...
# ✅ Use different shapes for accepted/rejected instead of color only
# accepted → circles ('o'), rejected → crosses ('x')
# smaller size to reduce overlap
...
# ✅ Mark starting point for reference
