...
static void map_Q_scale(double dec_strength, double nor_strength, double inc_strength, double *out_scale)
{
...
void fuzzy_update(const fuzzy_inputs_t *in, fuzzy_outputs_t *out)
{
    ...
    //const double m_med_a = 3.0; // unused
    ...
    const double acc_high_a = 1.5, acc_high_b = 4.0; // Accel norm (m/s^2)
